...
public final class Config implements ConfigValidator {
    ...
    public SpicordSettings spicord = new SpicordSettings(true, true, true, "<blue>[Discord]</blue> %role% %username% » {message}", "**%channel%** %sender% » {message}", Map.of("public", "1127207189547847740"));
